...
REM docker rm --force oraclexe
REM docker rmi oraclebasic
REM docker build -t oraclebasic .
REM docker run -d --name oraclexe -p 1541:1541 -p 1521:1521 -p 5500:5500 -v dadosxe:/opt/oracle/oradata oraclebasic
REM docker network connect myNetwork oraclexe
