 ...
 *   test_bridge <ORABRIDGE.EXE>    roda o executavel com um banco inexistente e confere o "ERR"
 */
...
{
    char *path = make_temp_path("orabridge_t1.dbf"), msg[256];
...
{
    char *path = make_temp_path("orabridge_t2.dbf"), msg[256];
...
{
    char *path = make_temp_path("orabridge_t3.dbf"), msg[256];
    Dbf d;
    char *f;
    ...
    {   /* formatos que o Oracle/ODPI-C devolve: ".5", expoente, negativos */
...
{
    char *path = make_temp_path("orabridge_t4.dbf"), msg[256];
    Dbf d;
    char *f;
    char longo[301];
...
{
    char *req = make_temp_path("ORAT1.REQ"), *rsp = make_temp_path("ORAT1.RSP");
